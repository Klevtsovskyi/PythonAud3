...
DATE1 = r"\b(?P<d1>\d{1,2})\.(?P<m1>\d{1,2})\.(?P<y1>\d{1,4})"  # 12.3.1999
DATE2 = r"\b(?P<y2>\d{1,4})\-(?P<m2>\d{1,2})\-(?P<d2>\d{1,2})"  # 1999-3-12
DATE3 = r"\b(?P<y3>\d{1,4})/(?P<m3>\d{1,2})/(?P<d3>\d{1,2})"    # 1999/3/12
